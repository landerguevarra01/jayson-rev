...
export default function Hero() {
  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center text-[80px]">
        ...
        <div>
          <h1 className="">HEY THERE! I’M SANSAN, A</h1>
        </div>
        <div className="flex flex-col justify-center items-center">
          <div className="w-fit flex justify-center items-center gap-4 border-[#DB0102] border-solid bg-[#DB0102] hover:border-[#B0B0B0] hover:border-solid hover:bg-[white] hover:text-[#DB0102] text-[#1D1D1D] rounded-full px-10">
